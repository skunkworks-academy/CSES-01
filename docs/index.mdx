...
<div className="course-grid">
  <CourseCard
    ...
    to="/modules/strategic-initiation-governance"
  />
  <CourseCard
    ...
    to="/modules/defender-cloud-posture"
  />
  <CourseCard
    ...
    to="/modules/workload-protection"
  />
  <CourseCard
    ...
    to="/modules/ai-security-identity"
  />
</div>
...
3. Complete [Module 1](./modules/strategic-initiation-governance).
